...
/**
  * @title Moonwell's Legacy InterestRateModel Interface
  * @author Moonwell (modified by Arr00)
  */
contract LegacyInterestRateModel {
    ...
    /**
      ...
      * @return error code (0 = no error), The borrow rate per timestmp (as a percentage, and scaled by 1e18)
      */
