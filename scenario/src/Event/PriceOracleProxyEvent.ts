  ...
  return [
    new Command<{params: EventV}>(`
        ...
        * "Deploy ...params" - Generates a new price oracle proxy
          * E.g. "PriceOracleProxy Deploy (Unitroller Address) (PriceOracle Address) (qiAvax Address)"
      `,
      "Deploy",
      [
    ...
    new View<{priceOracleProxy: PriceOracleProxy, apiKey: StringV, contractName: StringV}>(`
        ...
        * "Verify apiKey:<String> contractName:<String>=PriceOracleProxy" - Verifies PriceOracleProxy in Avaxscan
    ...
    new Command<{priceOracleProxy: PriceOracleProxy, amount: NumberV}>(`
        ...
        * "SetSaiPrice <Amount>" - Sets the per-avax price for SAI
